...
if [ ! -f "$THEME_DIR/theme.json" ]; then
  "$SCRIPT_DIR/switch-theme-macos.sh" --id preset-kung-fu-womens-football --no-apply >/dev/null
else
...
printf 'Codex Skin Studio Studio %s installed at %s for Codex %s using its signed Node.js %s.\n' \
