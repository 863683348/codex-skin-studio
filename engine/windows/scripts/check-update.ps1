...
$repository = '863683348/codex-skin-studio'
...
function Show-DreamSkinUpdateResult {
  ...
  if ($Result.updateAvailable) {
    $choice = [System.Windows.Forms.MessageBox]::Show(
      "Codex Skin Studio $($Result.latestVersion) is available.`r`n`r`nOpen the GitHub download page?",
      'Codex Skin Studio Update',
  ...
  [void][System.Windows.Forms.MessageBox]::Show(
    "Codex Skin Studio $($Result.currentVersion) is up to date.",
    'Codex Skin Studio Update',
