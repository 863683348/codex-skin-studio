...
export const en: Dict = {
  ...
  community: {
    ...
    submitDesc: 'Want your Codex theme to reach more people? Fill out the form below — once approved, it will appear in the community skin list.',
    submitCta: 'Submit My Skin',
    submitNameZh: 'Chinese name',
    submitNameZhPh: 'e.g. Galaxy',
    submitNameEn: 'English name',
    submitNameEnPh: 'e.g. Galaxy',
    submitRepo: 'GitHub repo (optional)',
    submitRepoPh: 'https://github.com/user/repo',
    submitUrl: 'Original link',
    submitUrlPh: 'Skin preview / download URL',
    submitColor: 'Primary color (optional)',
    submitColorPh: '#7C3AED',
    submitDescLabel: 'Description (optional)',
    submitDescPh: 'One sentence on the inspiration behind this skin',
    submitRequired: 'Required',
    submitSuccess: 'Submitted! We\'ll review it within 1-3 business days.',
    submitError: 'Submission failed. Please try again later.',
    submitRateLimit: 'Too many submissions. Please try again later.',
  },
};
