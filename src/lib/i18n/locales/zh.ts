export const zh = {
  ...
  home: {
    ...
    ctaBrowse: '浏览主题',
    ctaQuickstart: '快速开始',
    introTitle: 'Codex Skin Studio 是什么？',
    introLead: 'Codex Skin Studio 是一款面向 Codex 桌面端的安全开源换肤工具，通过本机 CDP 回环注入，在运行时改变界面外观，全程不触碰任何官方磁盘文件。无论你是想要一套更顺眼的配色，还是想把工作区调成专属风格，它都能在不破坏签名、不影响官方更新的前提下达成。',
    introBody1: '与传统的"破解/改包"方式不同，本工具采用运行时注入：启动后通过 127.0.0.1 本机回环连接 Codex 的调试端口，注入 CSS 覆盖样式；关闭工具后，所有样式立即还原，官方文件保持原样。这意味着每一次 Codex 版本更新都不会因为换肤而"变砖"，你随时可以一键回到官方外观。',
    introBody2: '目前内置 8 款以上精选主题，覆盖粉系、科幻、暗黑、清新等多种风格，并支持亮色 / 暗色双模式切换。免费版即可套用全部预设；Pro 版进一步开放自定义背景图与配色，把你喜欢的图片设为主题壁纸，保存为专属预设。',
    introPoints: [
      '运行时 CDP 注入，零官方文件修改',
      '8+ 预设主题，支持亮色 / 暗色',
      '可导入自定义背景图与配色方案',
  ...
  community: {
    ...
    backToGallery: '← 返回画廊',
    submitTitle: '提交你的皮肤',
    submitDesc: '想让自己的 Codex 主题被更多人看到？填写下方表单，审核通过后就会出现在社区皮肤列表中。',
    submitCta: '提交我的皮肤',
    submitNameZh: '中文名',
    submitNameZhPh: '例如：星河',
    submitNameEn: '英文名',
    submitNameEnPh: '例如：Galaxy',
    submitRepo: 'GitHub 仓库地址（选填）',
    submitRepoPh: 'https://github.com/user/repo',
    submitUrl: '原始链接',
    submitUrlPh: '皮肤预览 / 下载地址',
    submitColor: '主色（选填）',
    submitColorPh: '#7C3AED',
    submitDescLabel: '简介（选填）',
    submitDescPh: '用一句话介绍这个皮肤的灵感来源',
    submitRequired: '必填项',
    submitSuccess: '提交成功！我们会在 1-3 个工作日内审核。',
    submitError: '提交失败，请稍后重试。',
    submitRateLimit: '提交太频繁，请稍后再试。',
  },
} as const;
